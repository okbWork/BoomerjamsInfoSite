...
> The form posts via FormSubmit to `kobbowork@gmail.com`. In local/offline environments, submission can fail and the UI will show a fallback error message with direct email instructions.
